...
class BasicTest {
    ...
    void basicPropertyTest() {
        ...
        assertEquals(ExpressionType.PROPERTY, parsingResult.getExpressions().get(0).getType(),
                "0 of type " + ExpressionType.PROPERTY.name());
        ...
        assertEquals(ExpressionType.COMPARISON, parsingResult.getExpressions().get(1).getType(),
                "1 of type " + ExpressionType.COMPARISON.name());
        ...
        assertEquals("'GAUTIER'", parsingResult.getExpressions().get(2).getValue(), "Tuple 2 with value 'GAUTIER'");
    ...
    void parenthesisTest() {
        ...
        assertEquals("'GAUTIER'", parsingResult.getExpressions().get(3).getValue(), "Tuple 3 with value 'GAUTIER'");
        ...
        assertEquals("firstname", parsingResult.getExpressions().get(5).getValue(), "Tuple 1 with value 'firstname'");
        ...
        assertEquals("'JEROME'", parsingResult.getExpressions().get(7).getValue(), "Tuple 7 with value 'JEROME'");
